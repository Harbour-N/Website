---
title: "The Mathematics of Perlin noise, and implentation in Python"
...
plt.plot(X_,Y_,'k*')
plt.hlines(y = 0, xmin = -0.1, xmax = 1.1,color='k', linestyles='--')
plt.hlines(y = 1, xmin = -0.1, xmax = 1.1, color='k', linestyles='--')
plt.vlines(x = 0, ymin = -0.1, ymax = 1.1,color='k', linestyles='--')
plt.vlines(x = 1, ymin = -0.1, ymax = 1.1, color='k', linestyles='--')
